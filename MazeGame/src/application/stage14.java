...
public class stage14 implements Initializable
{
    ...
    AnimationTimer timer1 = new AnimationTimer() {
        ...
        public void handle(long timestamp) {
        	...
        	if(aPressed.get())
        	{
        		...
        		counter += touchrectangle(rect13 , vehicle , 1);
        		counter += touchrectangle(rect14 , vehicle , 1);
        		counter += touchrectangle(rect15 , vehicle , 1);
        		counter += touchrectangle(rect16 , vehicle , 1);
        		counter += touchrectangle(rect17 , vehicle , 1);
        		counter += touchrectangle(rect18 , vehicle , 1);
        		counter += touchrectangle(rect19 , vehicle , 1);
        		counter += touchrectangle(rect20 , vehicle , 1);
        		counter += touchrectangle(rect21 , vehicle , 1);
        		...
        		if((touchtheflag(goalflag , vehicle)|| touchtheflag(goalflag1 , vehicle)) && time_remaining>0)
        		{
        	...
        	if(dPressed.get())
        	{
        		...
        		counter += touchrectangle(rect13 , vehicle , 2);
        		counter += touchrectangle(rect14 , vehicle , 2);
        		counter += touchrectangle(rect15 , vehicle , 2);
        		counter += touchrectangle(rect16 , vehicle , 2);
        		counter += touchrectangle(rect17 , vehicle , 2);
        		counter += touchrectangle(rect18 , vehicle , 2);
        		counter += touchrectangle(rect19 , vehicle , 2);
        		counter += touchrectangle(rect20 , vehicle , 2);
        		counter += touchrectangle(rect21 , vehicle , 2);
        	...
        	if(wPressed.get())
        	{
        		...
        		counter += touchrectangle(rect13 , vehicle , 3);
        		counter += touchrectangle(rect14 , vehicle , 3);
        		counter += touchrectangle(rect15 , vehicle , 3);
        		counter += touchrectangle(rect16 , vehicle , 3);
        		counter += touchrectangle(rect17 , vehicle , 3);
        		counter += touchrectangle(rect18 , vehicle , 3);
        		counter += touchrectangle(rect19 , vehicle , 3);
        		counter += touchrectangle(rect20 , vehicle , 3);
        		counter += touchrectangle(rect21 , vehicle , 3);
        	...
        	if(sPressed.get())
        	{
        		...
        		counter += touchrectangle(rect13 , vehicle , 4);
        		counter += touchrectangle(rect14 , vehicle , 4);
        		counter += touchrectangle(rect15 , vehicle , 4);
        		counter += touchrectangle(rect16 , vehicle , 4);
        		counter += touchrectangle(rect17 , vehicle , 4);
        		counter += touchrectangle(rect18 , vehicle , 4);
        		counter += touchrectangle(rect19 , vehicle , 4);
        		counter += touchrectangle(rect20 , vehicle , 4);
        		counter += touchrectangle(rect21 , vehicle , 4);
